...
struct plus<void> {
    ...
    constexpr auto operator()(_Ty1&& _Left, _Ty2&& _Right) const
        // 바깥 noexcept는 함수의 예외 처리 규정을 지정한다. 
        // 안 쪽의 noexcept는 스펙이 아닌 expression에 대한 operator이다. 
        // - 특정 expression이 noexcept 스펙을 갖는 지 확인하는 용도로 사용한다. 
        // http://egloos.zum.com/sweeper/v/3148916

        // auto와 decltype을 통한 타잎 추론은 매우 강력하다. 
