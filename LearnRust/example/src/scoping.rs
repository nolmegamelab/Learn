...
pub fn look_borrowing() {
...

    {
        ...
        // 아래가 바뀐 메세지이고 개념을 move와 borrow로 나누면 된다.
...
pub fn look_mutable_borrow() {
    ...
    // mutable 참조는 만들 수 있지만 아래는 다른 의미이다. (어떤 의미?)
...
pub fn look_ref_pattern() {
    ...
    // A mutable copy of `point`. Point가 Copy이기 때문에 가능
